...
## Создание облачной инфрастурктуры
...
- Несколько виртуальный машин, выполняющих роли рабочих нод в будущем кластере k8s, распределенных между зонами b и d.
...
- Если комиту был присвоен тэг, то образ помечается этим тегом и дополнительно происходит этап деплоя данного образа в кластере k8s.
